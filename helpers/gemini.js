...
const geminiInsight = async (userPrompt) => {
  try {
    ...
    const prompt = `Sebagai seorang AI yang rasional, understanding, dan heartwarming bisa berikan insight ataupun pelajaran yang bisa saya ambil tentang jurnal saya? ini jurnal saya: "${userPrompt}", 
